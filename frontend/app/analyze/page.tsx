    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="py-16 px-6">
        <div className="max-w-6xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/5 border border-white/20 rounded-full text-zinc-300 text-sm mb-6">
          ...
          <div className="flex flex-wrap justify-center gap-4 text-sm">
            <div className="flex items-center gap-2 px-4 py-2 bg-zinc-900 border border-zinc-800 rounded-full">
              <span className="text-white">✓</span> Wallet Analysis
            </div>
            <div className="flex items-center gap-2 px-4 py-2 bg-zinc-900 border border-zinc-800 rounded-full">
              <span className="text-white">✓</span> Smart Contract Audit
            </div>
            <div className="flex items-center gap-2 px-4 py-2 bg-zinc-900 border border-zinc-800 rounded-full">
              <span className="text-white">✓</span> Real-time Alerts
            </div>
          </div>
        </div>
      </section>
      ...
      <main className="px-6 pb-20">
        <div className="max-w-5xl mx-auto">
          {/* Tab Navigation */}
          <div className="flex gap-2 mb-8 p-1 bg-zinc-900 border border-zinc-800 rounded-xl w-fit mx-auto">
            <button
